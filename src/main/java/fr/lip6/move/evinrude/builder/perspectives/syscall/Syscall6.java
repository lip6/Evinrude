 ...
 */
public class Syscall6 extends AbstractRule implements IRule, IRuleInstruction {
	...
	public Syscall6() {
		...
		this.dictionnary.add("free");
		//this.dictionnary.add("memset");
		this.dictionnary.add("memmove");
	}
