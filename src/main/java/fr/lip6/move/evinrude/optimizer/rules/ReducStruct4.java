...
public class ReducStruct4 extends Reduction {
	 ...
	 */
	@Override
	public final void performReduction(IModel model, INode node) throws EvinrudeException {
		LOG.info(">\tReduction Rule: " + this.getName());

		// Suppression de la transition
		model.removeNode(node);
		LOG.fine("\tSuppression de la transition " + node.getName());
	}
}
